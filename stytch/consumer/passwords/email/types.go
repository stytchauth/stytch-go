...
//
//   - ResetPasswordRedirectURL: The url that the user clicks from the password reset email to finish the
//     reset password flow.
...
//
//   - ResetPasswordExpirationMinutes: Set the expiration for the password reset, in minutes. By default,
...
//   - Attributes: Provided attributes help with fraud detection.
//
//   - LoginRedirectURL: The URL Stytch redirects to after the OAuth flow is completed for a user that
...
//
//   - ResetPasswordTemplateID: Use a custom template for password reset emails. By default, it will use
