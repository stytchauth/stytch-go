...
// Update: Updates an existing M2M Client. You can use this endpoint to activate or deactivate an M2M
// Client by changing its `status`. A deactivated M2M Client will not be allowed to perform future token
// exchange flows until it is reactivated.
//
