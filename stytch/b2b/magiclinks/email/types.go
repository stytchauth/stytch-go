...
//
//   - InviteRedirectURL: The URL that the Member clicks from the invite Email Magic Link. This URL should
//     be an endpoint in the backend server that verifies
...
//     email template. The template must be a template
...
//   - EmailAddress: The email address of the Member.
//
//   - LoginRedirectURL: The URL that the Member clicks from the login Email Magic Link. This URL should be
...
//
//   - SignupTemplateID: Use a custom template for signup emails. By default, it will use your default
//     email template. The template must be a template
//     using our built-in customizations or a custom HTML email for Magic Links - Signup.
//
//   - Locale: Used to determine which language to use when sending the user this delivery method.
//     Parameter is a [IETF BCP 47 language tag](https://www.w3.org/International/articles/language-tags/),
//     e.g. `"en"`.
