...
//
//   - DiscoveryRedirectURL: The URL that the end user clicks from the discovery Magic Link. This URL
//     should be an endpoint in the backend server that
...
//
//   - LoginTemplateID: Use a custom template for discovery emails. By default, it will use your default
