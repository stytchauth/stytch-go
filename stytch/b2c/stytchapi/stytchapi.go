...
import (
	...
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/cryptowallet"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/magiclink"
	mle "github.com/stytchauth/stytch-go/v9/stytch/b2c/magiclink/email"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/oauth"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/otp"
	otpe "github.com/stytchauth/stytch-go/v9/stytch/b2c/otp/email"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/otp/sms"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/otp/whatsapp"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/password"
	pe "github.com/stytchauth/stytch-go/v9/stytch/b2c/password/email"
	pep "github.com/stytchauth/stytch-go/v9/stytch/b2c/password/existingpassword"
	ps "github.com/stytchauth/stytch-go/v9/stytch/b2c/password/session"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/session"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/totp"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/user"
	"github.com/stytchauth/stytch-go/v9/stytch/b2c/webauthn"
...
func NewAPIClient(ctx context.Context, env config.Env, projectID string, secret string, opts ...Option) (*API, error) {
	a := &API{
...
// Close stops the background JWKS fetch for the API client.
func (a *API) Close() {
	a.Sessions.JWKS.EndBackground()
}
